package net.berachad.myapplication;
...
import net.berachad.myapplication.model.GitUser;
import net.berachad.myapplication.model.GitUsersResponse;
import net.berachad.myapplication.model.UsersListViewModel;
import net.berachad.myapplication.service.GitRepoServiceAPI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewUsers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Log.i("info",login);
                Intent intent=new Intent(getApplicationContext(), net.berachad.myapplication.RepositoryActivity.class);
